...
const T = {
  es: {
    ...
    s1Body: "Sintérgica AI (en adelante, \u201cSintérgica\u201d), con domicilio en Ciudad de México, México, es responsable del tratamiento de sus datos personales conforme a lo dispuesto por la Ley Federal de Protección de Datos Personales en Posesión de los Particulares (LFPDPPP) y su Reglamento.",
  ...
  en: {
    ...
    s1Body: "Sintérgica AI (hereinafter, \u201cSintérgica\u201d), with domicile in Mexico City, Mexico, is responsible for the processing of your personal data in accordance with the Federal Law on Protection of Personal Data Held by Private Parties (LFPDPPP) and its Regulations.",
  ...
  "pt-br": {
    ...
    s1Body: "A Sintérgica AI (doravante, \u201cSintérgica\u201d), com domicílio na Cidade do México, México, é responsável pelo tratamento de seus dados pessoais conforme disposto pela Lei Federal de Proteção de Dados Pessoais em Posse de Particulares (LFPDPPP) e seu Regulamento.",
