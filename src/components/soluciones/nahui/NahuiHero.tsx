    ...
    >
      ...
      >
        ...
        <div className="max-w-4xl flex flex-col items-center">
          ...
          <m.span
            {...anim(0)}
            className="inline-flex items-center rounded-full border border-brand-accent-light/20 bg-brand-accent-light/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-brand-accent-light"
          >
            Software Logístico
          </m.span>
          ...
          >
            Diseñado para la complejidad operativa de México y LATAM.
          </m.h1>
          ...
          >
            Combina trazabilidad operativa, control de ejecución en campo y visibilidad
            en tiempo real con la inteligencia de Lattice Na&apos;at. El único TMS integrado
            con IA privada soberana.
          </m.p>
