...
const T: Record<string, Record<Locale, IndustriaText>> = {
  ...
  gobierno: {
    es: {
      ...
      agentBio:
        "Carlos es el agente especializado para instituciones de los tres órdenes de gobierno y los tres poderes. Conoce los manuales de identidad institucional, redacta boletines y discursos en tono oficial, clasifica peticiones ciudadanas, analiza iniciativas legislativas y expedientes judiciales, y vigila el DOF junto a periódicos oficiales estatales y gacetas municipales. Opera completamente dentro de la infraestructura institucional.",
      agentCapabilities: [
        "Comunicación social: redacción de boletines, discursos, tarjetas informativas y posicionamientos en tono institucional",
        "Atención ciudadana: clasificación de peticiones, quejas y denuncias; respuestas a solicitudes LGTAIP y leyes locales de transparencia",
        ...
        "Adquisiciones públicas: análisis y publicación de licitaciones bajo LAASSP, LOPSRM y normativas estatales y municipales",
        "Monitoreo regulatorio: DOF, periódicos oficiales estatales y gacetas municipales por dependencia",
      ],
      useCases: [
        { title: "Comunicación social", description: "Boletines de prensa, discursos, tarjetas informativas y posicionamientos en tono institucional, alineados al manual de identidad de cada dependencia y nivel de gobierno.", icon: "Mail" },
        { title: "Atención ciudadana y transparencia", description: "Clasificación automática de peticiones, quejas y denuncias. Borradores de respuesta a solicitudes LGTAIP y leyes locales de transparencia con trazabilidad completa.", icon: "Users" },
        { title: "Procesos legislativos y judiciales", description: "Análisis de iniciativas, dictámenes y comparativos entre entidades. Estudio de expedientes, jurisprudencia y proyectos de sentencia para áreas técnicas y secretarías de acuerdos.", icon: "Scale" },
        { title: "Adquisiciones y cumplimiento", description: "Publicación y análisis de licitaciones bajo LAASSP, LOPSRM y leyes locales. Monitoreo continuo del DOF, periódicos oficiales estatales y gacetas municipales por dependencia.", icon: "Shield" },
      ],
      impactMetricLabels: [
    ...
    en: {
      ...
      agentBio:
        "Carlos is the specialized agent for institutions across the three levels of government and the three branches. He knows institutional style manuals, drafts press releases and speeches in official tone, classifies citizen requests, analyzes bills and court files, and monitors DOF along with state official gazettes and municipal bulletins. He operates entirely within institutional infrastructure.",
      agentCapabilities: [
        "Communications: press releases, speeches, talking points, and statements in institutional tone",
        "Citizen services: classification of requests, complaints, and grievances; drafted responses to LGTAIP and local transparency law requests",
        ...
        "Public procurement: analysis and publication of tenders under LAASSP, LOPSRM, and state and municipal laws",
        "Regulatory monitoring: DOF, state official gazettes, and municipal bulletins by agency",
      ],
      useCases: [
        { title: "Public communications", description: "Press releases, speeches, talking points, and statements in institutional tone, aligned to each agency's style manual and level of government.", icon: "Mail" },
        { title: "Citizen services and transparency", description: "Automatic classification of requests, complaints, and grievances. Draft responses to LGTAIP and local transparency law requests with full traceability.", icon: "Users" },
        { title: "Legislative and judicial support", description: "Analysis of bills, committee reports, and cross-jurisdictional comparisons. Review of case files, jurisprudence, and draft rulings for technical staff and clerks of court.", icon: "Scale" },
        { title: "Procurement and compliance", description: "Publication and analysis of tenders under LAASSP, LOPSRM, and local laws. Continuous monitoring of DOF, state official gazettes, and municipal bulletins by agency.", icon: "Shield" },
      ],
      impactMetricLabels: [
    ...
    "pt-br": {
      ...
      agentBio:
        "Carlos é o agente especializado para instituições dos três níveis de governo e dos três poderes. Conhece os manuais de identidade institucional, redige boletins e discursos em tom oficial, classifica pedidos da cidadania, analisa projetos de lei e processos judiciais, e monitora o DOF junto com diários oficiais estaduais e gazetas municipais. Opera completamente dentro da infraestrutura institucional.",
      agentCapabilities: [
        "Comunicação institucional: redação de boletins, discursos, notas técnicas e posicionamentos em tom oficial",
        "Atendimento ao cidadão: classificação de pedidos, queixas e denúncias; minutas de resposta a solicitações LGTAIP e leis locais de transparência",
        ...
        "Compras públicas: análise e publicação de licitações sob LAASSP, LOPSRM e normativas estaduais e municipais",
        "Monitoramento regulatório: DOF, diários oficiais estaduais e gazetas municipais por órgão",
      ],
      useCases: [
        { title: "Comunicação institucional", description: "Boletins de imprensa, discursos, notas técnicas e posicionamentos em tom oficial, alinhados ao manual de identidade de cada órgão e nível de governo.", icon: "Mail" },
        { title: "Atendimento e transparência", description: "Classificação automática de pedidos, queixas e denúncias. Minutas de resposta a solicitações LGTAIP e leis locais de transparência com rastreabilidade completa.", icon: "Users" },
        { title: "Suporte legislativo e judicial", description: "Análise de projetos de lei, pareceres e comparativos entre entidades. Estudo de processos, jurisprudência e minutas de sentença para áreas técnicas e cartórios.", icon: "Scale" },
        { title: "Compras e conformidade", description: "Publicação e análise de licitações sob LAASSP, LOPSRM e leis locais. Monitoramento contínuo do DOF, diários oficiais estaduais e gazetas municipais por órgão.", icon: "Shield" },
      ],
      impactMetricLabels: [
