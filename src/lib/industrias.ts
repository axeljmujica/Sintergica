...
const T: Record<string, Record<Locale, IndustriaText>> = {
  ...
  gobierno: {
    es: {
      ...
      subheadline:
        "Lattice Séeb Gobierno procesa licitaciones, genera reportes institucionales y monitorea normativa federal sin que tus datos salgan de la infraestructura del gobierno.",
      heroMetrics: [
      ...
      problemBody:
        "Las instituciones de gobierno manejan información sensible que no puede enviarse a servidores en Estados Unidos o Europa. Pero los modelos de IA disponibles no entienden CompraNet, LAASSP ni la estructura regulatoria mexicana.",
      problemPoints: [
        "Las herramientas de IA globales requieren enviar datos a servidores extranjeros",
        "Ningún modelo global conoce LAASSP, LOPSRM ni CompraNet",
        "La normativa federal mexicana cambia constantemente — los modelos globales no se actualizan",
        "La trazabilidad de decisiones es obligatoria y los modelos externos no la garantizan",
      ],
      agentRole: "Inteligencia Institucional — Lattice Séeb Gobierno",
      agentBio:
        "Carlos es el agente especializado para instituciones públicas. Conoce la Ley de Adquisiciones, CompraNet, los reglamentos de la APF y el marco normativo federal. Opera completamente dentro de la infraestructura institucional.",
      agentCapabilities: [
        "Análisis de licitaciones bajo LAASSP y LOPSRM",
        "Generación de reportes institucionales con formato oficial",
        "Monitoreo de normativa del DOF por dependencia",
        "Trazabilidad completa de consultas y decisiones",
        "Integración con sistemas de gobierno (SIDUR, CompraNet, SIPOT)",
      ],
      useCases: [
        { title: "Análisis de licitaciones", description: "Extracción y análisis de convocatorias en CompraNet. Carlos identifica oportunidades, requisitos técnicos y riesgos de participación.", icon: "Search" },
        { title: "Cumplimiento normativo", description: "Verificación continua de que los procesos internos cumplen con las leyes vigentes. Alertas automáticas cuando cambia la normativa.", icon: "Shield" },
        { title: "Reportes institucionales", description: "Generación automatizada de reportes periódicos con el formato y estructura requerida por la normativa federal.", icon: "ClipboardList" },
        { title: "Trazabilidad de procesos", description: "Registro inmutable de decisiones, consultas y acciones. Audit trail completo para transparencia y rendición de cuentas.", icon: "FileSearch" },
      ],
      impactMetricLabels: [
    ...
    en: {
      ...
      subheadline:
        "Lattice Séeb Government processes tenders, generates institutional reports, and monitors federal regulations without your data leaving government infrastructure.",
      heroMetrics: [
      ...
      problemBody:
        "Government institutions handle sensitive information that cannot be sent to servers in the United States or Europe. But available AI models don't understand CompraNet, LAASSP, or the Mexican regulatory structure.",
      problemPoints: [
        "Global AI tools require sending data to foreign servers",
        "No global model knows LAASSP, LOPSRM, or CompraNet",
        "Mexican federal regulations change constantly — global models don't update",
        "Decision traceability is mandatory and external models don't guarantee it",
      ],
      agentRole: "Institutional Intelligence — Lattice Séeb Government",
      agentBio:
        "Carlos is the specialized agent for public institutions. He knows the Acquisitions Law, CompraNet, APF regulations, and the federal regulatory framework. He operates entirely within institutional infrastructure.",
      agentCapabilities: [
        "Tender analysis under LAASSP and LOPSRM",
        "Institutional report generation in official format",
        "DOF regulation monitoring by agency",
        "Full traceability of queries and decisions",
        "Integration with government systems (SIDUR, CompraNet, SIPOT)",
      ],
      useCases: [
        { title: "Tender analysis", description: "Extraction and analysis of CompraNet calls. Carlos identifies opportunities, technical requirements, and participation risks.", icon: "Search" },
        { title: "Regulatory compliance", description: "Continuous verification that internal processes comply with current laws. Automatic alerts when regulations change.", icon: "Shield" },
        { title: "Institutional reports", description: "Automated generation of periodic reports with the format and structure required by federal regulations.", icon: "ClipboardList" },
        { title: "Process traceability", description: "Immutable record of decisions, queries, and actions. Complete audit trail for transparency and accountability.", icon: "FileSearch" },
      ],
      impactMetricLabels: [
    ...
    "pt-br": {
      ...
      subheadline:
        "O Lattice Séeb Governo processa licitações, gera relatórios institucionais e monitora normativa federal sem que seus dados saiam da infraestrutura do governo.",
      heroMetrics: [
      ...
      problemBody:
        "As instituições governamentais lidam com informações sensíveis que não podem ser enviadas a servidores nos Estados Unidos ou Europa. Mas os modelos de IA disponíveis não entendem CompraNet, LAASSP nem a estrutura regulatória mexicana.",
      problemPoints: [
        "As ferramentas de IA globais exigem envio de dados a servidores estrangeiros",
        "Nenhum modelo global conhece LAASSP, LOPSRM nem CompraNet",
        "A normativa federal mexicana muda constantemente — os modelos globais não se atualizam",
        "A rastreabilidade de decisões é obrigatória e os modelos externos não a garantem",
      ],
      agentRole: "Inteligência Institucional — Lattice Séeb Governo",
      agentBio:
        "Carlos é o agente especializado para instituições públicas. Conhece a Lei de Aquisições, CompraNet, os regulamentos da APF e o marco normativo federal. Opera completamente dentro da infraestrutura institucional.",
      agentCapabilities: [
        "Análise de licitações sob LAASSP e LOPSRM",
        "Geração de relatórios institucionais em formato oficial",
        "Monitoramento de normativa do DOF por órgão",
        "Rastreabilidade completa de consultas e decisões",
        "Integração com sistemas governamentais (SIDUR, CompraNet, SIPOT)",
      ],
      useCases: [
        { title: "Análise de licitações", description: "Extração e análise de editais no CompraNet. Carlos identifica oportunidades, requisitos técnicos e riscos de participação.", icon: "Search" },
        { title: "Conformidade regulatória", description: "Verificação contínua de que os processos internos cumprem as leis vigentes. Alertas automáticos quando a normativa muda.", icon: "Shield" },
        { title: "Relatórios institucionais", description: "Geração automatizada de relatórios periódicos com o formato e estrutura exigidos pela normativa federal.", icon: "ClipboardList" },
        { title: "Rastreabilidade de processos", description: "Registro imutável de decisões, consultas e ações. Trilha de auditoria completa para transparência e prestação de contas.", icon: "FileSearch" },
      ],
      impactMetricLabels: [
