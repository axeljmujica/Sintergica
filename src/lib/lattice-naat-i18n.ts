    ...
    models: [
      {
        ...
        context: "32K tokens",
        modality: "Texto",
        deployment: "On-premise · Borde · Móvil",
        useCase: "Dispositivos con recursos limitados, procesamiento sin conexión",
        featured: false,
      },
      {
        id: "compact",
  ...
  differentiators: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Cadenas de pensamiento complejas, análisis documental profundo y multimodalidad nativa (texto, imágenes y documentos) en Na'at Avanzado y Completo.",
      },
    ],
  },
